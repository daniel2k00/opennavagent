...
biases routes to stay close to public bomb shelters (OSM `amenity=shelter`).
Built with Israel in mind but works anywhere OSM has shelters mapped.
...
const skill = {
  ...
  description: 'Wartime routing that threads the path through OSM public shelters.',
